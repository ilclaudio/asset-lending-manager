...
class Plugin_Manager_Test extends TestCase {
	...
	public function test_singleton_instance() {
		$instance1 = ALMGR_Plugin_Manager::get_instance();
		$instance2 = ALMGR_Plugin_Manager::get_instance();

		$this->assertInstanceOf( ALMGR_Plugin_Manager::class, $instance1, 'Instance should be of class Plugin_Manager.' );
