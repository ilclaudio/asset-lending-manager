<?php
/**
 * Normalized result for shared asset queries.
 *
...
/**
 * Carries asset IDs and pagination metadata from the domain query service.
 *
 * Adapters must consume this result instead of receiving WP_Query instances.
 */
class ALMGR_Asset_Query_Result {

	/**
	 * Asset IDs returned by the query.
	 *
	 * @var int[]
	 */
	private $items;
	...
	public function __construct( array $items, $total, $page, $per_page, $pages ) {
		$this->items    = array_values( array_map( 'absint', $items ) );
	...
	/**
	 * Return asset IDs in the result.
	 *
	 * @return int[]
	 */
